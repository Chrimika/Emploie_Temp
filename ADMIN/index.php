      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="menu-header">CREATION</li>
            <li class="dropdown">
              <a href="ENSEIGNANTS/auth-register.php" class="nav-link"><i data-feather="user-plus"></i><span>Enseignants</span></a>
            </li>      
          </ul>
        </aside>
      </div>
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Enseignants</h5>
